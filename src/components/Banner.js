  ...
  return (
    <header className="banner">
      <div className="banner-container">
        ...
        <p className="banner-type">Film</p>
        </div>
        <h1 className="banner-title">Titre img</h1>
        <p className="banner-description">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita,
          facilis vitae blanditiis harum magni impedit laudantium natus
          perferendis? Ratione, nam officiis. Necessitatibus repellat quaerat
          animi fugit! Repellat labore deserunt aut?
        </p>
